...
public class MainAllocationProcessContainerTest {
	...
	// Constructor
	public MainAllocationProcessContainerTest(ContainerAllocationProblem containerAllocationProblem,
	...
	private boolean energyUpdate(double curerntTime, double previousTime) {
		...
		System.out.println(this.energyConsumption+" "+ curerntTime);
		return true;
	}
			...
			if (chosenVM < currentVmNum) {
				...
				if (chosenPM == null) {
					...
					pmResourceList.set(chosenPM,
							new Double[] { pmResourceList.get(chosenPM)[0] - vmTypeList.get(vmType)[0],
									pmResourceList.get(chosenPM)[1] - vmTypeList.get(vmType)[1],
									pmResourceList.get(chosenPM)[2], pmResourceList.get(chosenPM)[3],
									pmResourceList.get(chosenPM)[4], pmResourceList.get(chosenPM)[5],
...
//		System.out.println("privousUtil"+ " " + privousUtil + " "+ "newUtil" + " "+ newUtil);
